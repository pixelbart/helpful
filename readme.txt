...
= 4.2.8 =
* The species declarations have been removed from all files to make Helpful more compatible with older PHP versions.
* Added and corrected comments in the PHP files.
* Date: 17.02.2020

= 4.2.7 =
* The declaration of the type has been removed from `class-helpful-setup.php` because it was not compatible with low PHP versions.
* Date: 17.02.2020
...
* Fixed errors when loading Helpful by using the hook plugins_loaded instead of init.
* Fixed a bug where the customizer could not be loaded because Helpful had loaded its own customizer options incorrectly.
* Date: 05.02.2020
...
* Fixed CSS in Helpful's admin area.
* Date: 26.01.2019
