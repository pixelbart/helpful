...
<h2><?php echo esc_html( _x( 'Details', 'tab name', 'helpful' ) ); ?></h2>
...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
			...
			<div class="helpful-admin-group">
				<?php if ( $post_types ) : ?>
					<?php foreach ( $post_types as $post_type ) : ?>
						...
						<?php if ( $options->get_option( 'helpful_post_types', array(), 'esc_attr' ) ) : ?>
							<?php $checked = ( in_array( $post_type, $options->get_option( 'helpful_post_types', array(), 'esc_attr' ), true ) ) ? 'checked="checked"' : ''; ?>
							<label class="helpful-inline helpful-margin-right">
								<input type="checkbox" name="helpful_post_types[]" id="helpful_post_types[]" value="<?php echo esc_html( $post_type ); ?>" <?php echo esc_html( $checked ); ?>/>
	...
	<div class="helpful-admin-panel">
		...
		<div class="helpful-admin-panel-content">
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_exists_hide', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_count_hide', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_credits', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_hide_in_content', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_only_once', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_percentages', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_hide_admin_columns', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_shrink_admin_columns', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_feedback_disabled', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_ip_user', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_wordpress_user', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group">
				<label>
					<?php $value = $options->get_option( 'helpful_shortcode_post_types', 'off', 'on_off' ); ?>
	...
	<div class="helpful-admin-panel">
		...
		<div class="helpful-admin-panel-content">
			...
			<div class="helpful-admin-group">
				<label>
					<?php $value = $options->get_option( 'helpful_metabox', 'off', 'on_off' ); ?>
	...
	<div class="helpful-admin-panel">
		...
		<div class="helpful-admin-panel-content">
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_widget', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_widget_pro', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_widget_contra', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_widget_pro_recent', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_widget_contra_recent', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_feedback_widget', 'off', 'on_off' ); ?>
			...
			<div class="helpful-admin-group helpful-margin-bottom">
				<label>
					<?php $value = $options->get_option( 'helpful_widget_hide_publication', 'off', 'on_off' ); ?>
