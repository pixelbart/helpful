...
<p><?php _ex( 'Here you will find settings that Helpful can reset, or affect. Among other things you can set your own 
timezone, reset Helpful and set whether users can vote for a post more than once.', 'tab description', 'helpful' ); ?></p>
...
<form method="post" action="options.php">
  ...
  <div class="helpful-admin-panel">
    ...
    <div class="helpful-admin-panel-content">
      ...
      <p class="description"><?php echo esc_html_x("Here you'll find settings that might be useful, but didn't fit anywhere 
      else or cause confusion. Note that if you allow users to vote more than once, this means the individual posts. 
      Users can then vote more than once for a post.", 'admin panel description', 'helpful'); ?></p>
  ...
  <div class="helpful-admin-panel">
    ...
    <div class="helpful-admin-panel-content helpful_maintenance">
      ...
      <p class="description"><?php echo esc_html_x('Here you can maintain the plugin. The database will be checked if there 
      are any errors. In addition, feedback from older versions is moved into the database and old entries are deleted. 
      This feature will also be extended in the future if there is something new. You can find more about this in the changelogs.', 
      'admin panel description', 'helpful'); ?></p>
  ...
  <div class="helpful-admin-panel">
    ...
    <div class="helpful-admin-panel-content">
      ...
      <p class="description"><?php echo esc_html_x('Here you can reset Helpful. This affects all entries in the database as well as 
      the feedback. Settings are not affected. This action is irreversible, so be careful with it. If you want to reset individual 
      posts, you only have to activate the meta box under Details. Then switch to the post and reset Helpful there.', 
      'admin panel description', 'helpful'); ?></p>
