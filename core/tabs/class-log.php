...
class Log {
	 ...
	 * Enqueue scripts
	 *
	 * @param string $hook_suffix Current toplevel page.
	 */
	public function enqueue_scripts( $hook_suffix ) {
		...
		wp_enqueue_script( 'helpful-admin-log', $file, array( 'jquery' ), $plugin['Version'], true );
	...
	public function ajax_delete_rows() {
		...
		if ( array_key_exists( 'rows', $_REQUEST ) && is_array( $_REQUEST['rows'] ) ) {
