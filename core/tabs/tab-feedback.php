...
<p><?php _ex( 'Here you can activate a feedback form. The feedback form will be displayed after voting and 
can be configured here. Please note that the form is not spam protected.', 'tab description', 'helpful' ); ?></p>
...
<form method="post" action="options.php">
  ...
  <div class="helpful-admin-panel">
    ...
    <div class="helpful-admin-panel-content">
      ...
      <p class="description"><?php _ex('Here you can change the texts that are displayed directly in front of the feedback form. 
        Briefly explain to your visitors why they should give feedback.', 'admin panel description', 'helpful'); ?></p>
  ...
  <div class="helpful-admin-panel">
    ...
    <div class="helpful-admin-panel-content">
      ...
      <p class="description"><?php echo esc_html_x('Here you can set settings for the overview in the admin area. Some options only work in 
      combination with other options.', 'admin panel description', 'helpful'); ?></p>
