...
<p><?php _ex( 'Most texts can be changed here. Use <code>{pro}</code> for positive votes, <code>{contra}</code> for negative votes and <code>{permalink}</code> to get 
the URL of the current post. You can also leave fields blank to not display anything at this point.', 'tab description', 'helpful' ); ?></p>
