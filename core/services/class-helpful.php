<?php
/**
 * A service to set a single Helpful instance, with everything that goes with it.
 *
 * @package Helpful
...
class Helpful {
	 ...
	 */
	public function __construct( $post_id = null, $atts = array() ) {
	...
	/**
	 * Returns an array with css classes.
	 *
	 * @return array
	 */
