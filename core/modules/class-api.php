<?php
/**
 * Extends the WordPress REST API with the ability to vote Helpful.
 *
 * @package Helpful
...
class Api {
	...
	public function __construct() {
		add_action( 'rest_api_init', array( & $this, 'init_pro' ) );
		add_action( 'rest_api_init', array( & $this, 'init_contra' ) );
	}
